...
<section id="featured" class="padding bg_white">
    <div class="container">
        <div>
            <h2 class="heading">Featured &nbsp; Feedbacks</h2>
            <hr class="heading_space">
        </div>
        <div>
            <?php
            $result = $mysqli->query("SELECT * FROM feedbacks WHERE NOT hidden ORDER BY date DESC");
            ...
            <div class="row epic-li">
                ...
                <div class="col-md-4 right">
                    <form enctype="multipart/form-data" action="processes/feedback-process.php" method="post">
                        <button class="epic-btnred">Hide</button>
...
<section id="month" class="padding bg_white">
    <div class="container">
        <div style="text-align: right;"><a href="feedbacksall.php" class="epic-a">View all customer feedbacks ></a></div>
        <div>
            <h2 class="heading">Feedbacks &nbsp; This &nbsp; Month</h2>
            <hr class="heading_space">
        </div>
        <div>
            <?php
